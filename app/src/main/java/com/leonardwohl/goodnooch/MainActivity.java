...
public class MainActivity extends AppCompatActivity {
    ...
    public static NutritionManager manager;

    private String FILE_NAME = "temp.jpg";
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        item.buildNutritionItemFromResponse(response);

        String message = "I found these things:\n\n";
        message += "calories: ";
        message += item.calories;
        message += "\n";
        message += "fat: ";
        message += item.fat;
        message += "\n";
        message += "sat_fat: ";
        message += item.sat_fat;
        message += "\n";
        message += "trans_fat: ";
        message += item.trans_fat;
        message += "\n";
        message += "cholesteral: ";
        message += item.cholesteral;
        message += "\n";
        message += "sodium: ";
        message += item.sodium;
        message += "\n";
